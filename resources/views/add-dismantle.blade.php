        ...
        <div class="card-header py-3">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="month_id" name="month_id" placeholder="Pilih Bulan" require>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="poe" name="poe" require>
                        <option>-- PoE --</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="bracket" name="bracket" require>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="candidate" name="candidate" require>
